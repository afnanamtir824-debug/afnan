// إصلاح: تم رفع رقم النسخة (v19 -> v20) لأن رابط مكتبة Dexie تغيّر أدناه (تثبيت إصدار 3)،
// حتى يحذف حدث "activate" الكاش القديم الذي يحمل الرابط القديم غير المثبّت بإصدار،
// ولضمان استلام كل الأجهزة نسخة sw.js المحدّثة بدل الاستمرار بالنسخة القديمة من الكاش.
const CACHE_NAME = 'field-tech-v20';
