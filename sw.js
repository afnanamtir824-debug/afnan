// إصلاح: رفع رقم النسخة مجدداً (v20 -> v21) لأن app.js و index.html تغيّرا بشكل جوهري
// (نظام الصلاحيات الجديد بأربعة أدوار + تسجيل الدخول عبر السيرفر)، فيجب حذف الكاش
// القديم لضمان تحميل كل الأجهزة للنسخة الجديدة فوراً بدل الاستمرار بتشغيل كود قديم
// يفترض وجود localStorage-only auth الذي لم يعد موجوداً.
const CACHE_NAME = 'field-tech-v21';
